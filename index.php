        ...
        <title>Omnifood</title>
            ...
            <body>
                    ...
                    <ul class="meals-showcase clearfix">
                        <li>
                            <figure class="meal-photo">
                                <img src="resources/img/1.jpg" alt="Korean bibimbap\'a0with egg and vegetables">
                            </figure>
                        </li>
                        <li>
                            <figure class="meal-photo">
                ...
                <section class="section-steps">
                    <div class="row">
                        <h2>How it works &mdash; Simple as 1, 2, 3</h2>x
                    </div>
                    <div class="row">
...
<script src="vendors/js/gmaps.min.js"></script>
